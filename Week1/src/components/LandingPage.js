    ...
    return (
        <div className="container text-center mt-5">
            <div className="jumbotron bg-light p-5">
                <h1 className="display-4">Welcome to CollabNation</h1>
                <p className="lead">
                    CollabNation is your go-to platform for seamless real-time collaboration. 
                ...
                <p>
                    ...
                    CollabNation offers all the features you need to stay productive.
                </p>
                <div className="mt-4">
